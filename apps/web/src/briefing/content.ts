...
export const BRIEFING_SLIDES: readonly BriefingSlide[] = [
  ...
  },
  {
    ...
    depth: "core",
    title: "Prove the basin one of three ways.",
    lead: "Complete any Charter at the end of a round. Every qualifying expedition wins—so rivals can cross the line together.",
    visual: "charters",
    callout: "Network · Discovery · Dominion",
    speakerNotes: [
  ...
  },
  {
    ...
    lead: "Everyone sees the same basin, infrastructure, pressure, and public evidence. Only you see your hidden routes, Signal, cargo, traps, and reports.",
    visual: "truth",
